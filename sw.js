const CACHE='shlav-a-v10.64.100';
...
// handler — a missing optional asset must not abort install.
//
// Note (v10.64.18): tokens.css + study_plan_*.js are loaded SYNCHRONOUSLY by
// shlav-a-mega.html (no defer/async). They block first paint and study-plan
// rendering, so they belong in the critical set — install must guarantee they
// land in cache, otherwise first offline launch can degrade or break.
const CRITICAL_URLS=['shlav-a-mega.html','manifest.json','shared/fsrs.js','shared/tokens.css','src/storage.js','src/sw-update.js','src/study_plan_algorithm.js','src/study_plan.js'];
...
const JSON_DATA_URLS=['data/questions.json','data/explanations.json','data/topics.json','data/notes.json','data/drugs.json','data/flashcards.json','harrison_chapters.json','data/hazzard_chapters.json','data/grs8_chapters.json','data/grs8_question_pages.json','data/tabs.json','data/question_chapters.json','data/distractors.json','data/regulatory.json','data/syllabus_data.json'];
