...
```
/
├── shlav-a-mega.html        # Main app (THE file — all HTML/CSS/JS, v10.64.150)
...
│
├── tests/                          # 90 vitest files, 1,596 tests + 7 skipped (see Testing section)
│
...
- Currently all three at `10.64.150` (sw.js cache key: `shlav-a-v10.64.150`)
...
**Test file inventory (90 files, 1,615 tests + 7 skipped — current as of v10.64.150; prior tally at v10.64.86 was 61 files / 1,270 tests):**
...
| Test suite | 1,602 tests across 90 files + 7 skipped (vitest) |
...
| App version | v10.64.150 |
| SW cache key | `shlav-a-v10.64.150` |
