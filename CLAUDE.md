...
│   ├── questions.json       # 4,297 MCQs (primary runtime source; explanations in data/explanations.json; 4,294/4,297 carry `ref` — 3 unsourced)
...
| Questions | 4,647 (IMA past exams + Hazzard/Harrison AI-generated + GRS8 imports; explanations in data/explanations.json) |
| Topics | 46 |
| Drugs | 113 |
| Flashcards | 159 |
| Study notes | 46 |
