...
```
/
├── shlav-a-mega.html        # Main app (THE file — all HTML/CSS/JS, v10.64.188)
...
- Currently all three at `10.64.188` (sw.js cache key: `shlav-a-v10.64.188`)
...
### Testing
```bash
npm test             # Run all tests (vitest, 1,602 tests across 90 files + 7 skipped)
npm run verify       # Pre-push gate (see below) — runs 7 checks in series
```

**1,602 tests across 90 files (~18 tests per file avg)** — run `npm test` to see current count.
...
**Test file inventory (108 files, 1,615 tests + 7 skipped — current as of v10.64.188; prior tally at v10.64.86 was 61 files / 1,270 tests):**
...
| Metric | Value |
|---|---|
| Main file | `shlav-a-mega.html` (~8,493 lines, ~580 KB) |
| Named functions | 227 (231 incl. shared/*.js, the integrity-guard counting basis) |
| Questions | 4,297 (IMA past exams + Hazzard/Harrison AI-generated + GRS8 imports; explanations in data/explanations.json; 4,294/4,297 carry `ref` — 3 unsourced) |
| Topics | 46 |
| Drugs | 113 |
| Flashcards | 159 |
| Study notes | 46 |
...
| App version | v10.64.188 |
| SW cache key | `shlav-a-v10.64.188` |
